...
const form = ref({ type: '', value: '', starts_at: '', ends_at: '', business_id: '' });
const submitDiscount = () => {
  Swal.fire('Saving discount...');
  router.post('/discounts', form.value);
};
</script>
<template>
  <AppLayout>
    <div class="p-6">
      <PageHeader title="Create Discount" :button="{ text: 'Back to Discounts', link: '/discounts' }" />
