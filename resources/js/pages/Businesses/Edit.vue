                ...
                <div class="space-y-6">
                  <div>
                    ...
                    <div class="mt-1 flex items-center">
                      <img
                        v-if="form.logo || business.logo_url"
                        :src="form.logo ? URL.createObjectURL(form.logo) : business.logo_url"
                  ...
                  <div>
                    ...
                    <div class="mt-1 flex items-center">
                      <div class="flex-1">
                        <span v-if="business.tax_document_url" class="text-sm text-gray-500 dark:text-gray-400 mr-4">
                  ...
                  <div>
                    ...
                    <div class="mt-1 flex items-center">
                      <div class="flex-1">
                        <span v-if="business.registration_document_url" class="text-sm text-gray-500 dark:text-gray-400 mr-4">
...
const handleSubmit = async () => {
  try {
    ...
    // Submit the form
    await form.put(route('businesses.update', props.business.id), {
      onSuccess: () => {
        Swal.fire({
          icon: 'success',
          title: 'Success!',
