    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                ...
                <span class="status">{{ $status === 'activated' ? 'activated' : 'deactivated' }}</span>
                by a system administrator.
            </p>
            @if($status === 'activated')
                <p>
                    You now have full access to the system. If you have any questions or need assistance, please contact support.
                </p>
            @else
                <p>
                    Your access to the system has been temporarily suspended. If you believe this is a mistake or need further information, please contact support.
                </p>
            @endif
            <p>
